...
#define LIBFREENECT2_WITH_METAL_SUPPORT
#define LIBFREENECT2_OPENCL_ICD_LOADER_IS_OLD
...
// Threading always uses C++17 std::thread
#define LIBFREENECT2_THREADING_STDLIB 1

// C++17 is always enabled
#define LIBFREENECT2_WITH_CXX11_SUPPORT 1
