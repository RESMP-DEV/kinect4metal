# Review guidance for RESMP-DEV/kinect4metal
...
- Review RESMP-DEV/kinect4metal as the source of truth for macOS-native Kinect v2 driver with Metal compute (MIT license, derived from libfreenect2).
